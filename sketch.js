var dustbin2,dustbin3,paperball,sceneState,i,launcher;
...
function setup() {
	...
	launcher = new Launcher(paperball.body,{x:100,y:200});
...
function draw() {
  ...
  fill("black");
  textSize(30);
  text("launch the floating paper into the dustbin using the power of nature",0,120);
